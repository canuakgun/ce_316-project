...
/**
 * Application entry point that does NOT extend
 * {@link javafx.application.Application}.
 *
 * <p>
 * When a class that extends {@code Application} is used as the JAR manifest's
 ...
 *
 * <p>
 * Declaring a <strong>separate</strong> launcher class that does not extend
 ...
 *
 * <p>
 * Both the {@code maven-shade-plugin} manifest and the IDE run configuration
